 <div style="max-width: 700px; margin:auto;">
    ...
    <form action="<?php echo base_url('barang/proses_ubah'); ?>" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="date" class="form-control" name="tgl_masuk"  value="<?= $barang['tgl_masuk']; ?>">
        </div>
        <div class="form-group">
            <label for="tgl_keluar">Tanggal Keluar</label>
            <input type="date" class="form-control" name="tgl_keluar"  value="<?php echo $barang['tgl_keluar']; ?>">
        </div>
        <div class="form-group">
            <label for="foto_barang">Foto Barang</label>
			<input type="file" class="form-control" name="foto_barang"  value="<?php echo $barang['foto_barang']; ?>">
        	<div style="display: flex; justify-content: end;">
				<img src="<?php echo base_url(); ?>/uploads/<?php echo $barang['foto_barang'] ?>" width="100" height="150" style="margin-left: auto;">
			</div>
		</div> 
